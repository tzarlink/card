<?php
	...
	$sql = "select c.username as admin_username , u.*,c.*,u.username from `card_company` c left join `card_user` u on c.id=u.pid where u.username='$_GET[u]'";
	$res = mysql_query($sql);
...
a{text-decoration:none;outline:none;color:#0A8AC5}
...
.head{ background:url(m/head-bg.png) repeat-x; height:88px; position:relative}

	.head .logo{ margin-top:25px; margin-left:20px;}
	.head .search-bg{ background:url(m/search-img.png) no-repeat; width:367px; height:62px; margin-top:12px; margin-left:20px;}
	.head .search-bg .input-search{ height:58px; line-height:normal; width:285px; color:#7FB4DF; margin-top:2px; margin-left:50px; font-size:28px;  border:none; background:url(m/input-bg.png) repeat-x; padding-left:5px;}
...
.foot-nav{ position:fixed; bottom:0;}
	...
	.foot-nav .foot-list1 li{ float:left; background:url(m/card/foot-libg.png) repeat-y right; width:128px; text-align:center; color:#fff;text-shadow: 1px 1px 0 #454545; position:relative}
	...
	.foot-nav .foot-list3 li.t2{ width:256px;}
        ...
        .main-card12{background:#F2F2F4; height:100%;}
.main-card12 .logo{padding:80px 0 140px 0; text-align:center}
.main-card12 .card-bg{padding-left:65px;line-height:1.1em; color:#434343; font-size:42px;}
.main-card12 .card-bg span{ font-size:24px; color:#454545;}
.main-card12 .card-bg .name{ color:#1B1B1B}
.main-card12 .card-bg .phone{ font-size:28px;}
.main-card12 .enter-info{ /*  position:fixed;*/ margin-top:100px; bottom:100px; font-size:24px; line-height:1.5em; color:#454545; padding-left:40px; }
.main-card12 .enter-info .name{ background:#0A8AC5; padding:15px 20px; font-size:36px; color:#fff; margin-bottom:20px; width:560px;}
.main-card12 .enter-info p{ padding-left:20px;}
...
<div class="content">
    <div class="main-card12 touch">
		<img src="themes/kezhong/images/head_bg.jpg">
		<div class="logo" ><img height="100" src="<?php echo $rs['logo'] ?>"></div>
		
		
		<div class="card-box">
			<div class="card-bg">
				<div style="float:left;margin-right:20pt;margin-top:5pt">
					<a  href="<?php echo $rs['photo'] ?>"><img style='border:2px solid silver' height="115" src="<?php echo $rs['photo'] ?>"></a>
				</div>
				
				<div class="name" ><?php echo $rs['realname'] ?> <span><?php echo $rs['job'] ?></span></div>
				<p class="phone"  style="margin-top:-5pt">手机：<?php echo $rs['tel'] ?></p>
				
				<p style="font-size:16pt;line-height:24px"><span style="font-size:18pt;"><?php echo $rs['slogan'] ?></span><br/></p>
			</div>
		</div>
		

		<div class="enter-info">
			<div class="name"><?php echo $rs['company'] ?></div>
			<p>
				<img src="themes/kezhong/images/tel.png" style="position:absolute;margin-top:1pt"><span style="margin-left:30pt"><a href="tel:<?php echo str_replace('-','',$rs['tel']) ?>"><?php echo $rs['tel'] ?></a></span>
				<br><br>
				<img src="themes/kezhong/images/phone.png" style="position:absolute;margin-top:1pt"><span style="margin-left:30pt"><a href="tel:<?php echo str_replace('-','',$rs['phone']) ?>"><?php echo $rs['phone'] ?> </a></span>
				<br><br>
				<img src="themes/kezhong/images/qq.png" style="position:absolute;margin-top:1pt"><span style="margin-left:30pt"><a href="javascript:void(0)"><?php echo $rs['qq'] ?></a></span><br><br>
				<img src="themes/kezhong/images/mail.png" style="position:absolute;margin-top:2pt"><span style="margin-left:30pt"><a href="mail:<?php echo $rs['mail'] ?>"><?php echo $rs['mail'] ?></a></span><br><br>
				<img src="themes/kezhong/images/address.png" style="position:absolute;margin-top:1pt"><span style="margin-left:30pt"><a href="javascript:void(0)"><?php echo $rs['address'] ?></a></span><br><br/>
			<?php if($rs['admin_username']=='kezhong'){ ?>
				<img src="themes/kezhong/images/400.png" style="position:absolute;margin-top:1pt"><span style="margin-left:30pt"><a href="tel:4008981160">全国服务热线：400-898-1160 </a></span>
				<br><br> 
			<?php } ?>
				<img src="themes/kezhong/images/url.png" style="position:absolute;margin-top:1pt"><span style="margin-left:30pt"><a href="http://<?php echo $rs['site'] ?> "><?php echo $rs['site'] ?> </a></span>				
			</p>
...
<?php if($rs['admin_username']=='kezhong'){ ?>
			    <div class="lx-box">
                    <div class="tit">官方公众号</div>
						...
						<img src="themes/kezhong/images/qr.png" style="float:left"> 
								<p style=" width:285pt;float:right;font-size:12pt;line-height:20pt;  ">
								<?php echo $rs['about_us'] ?>
								</p>
						</p>
						 
						<div style="clear:both"></div>
                          <a href="javascript:void()0" style="color:gray">服务创造价值
						  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;服务传承文明</a>             
				<div class="downs-app"><a href="http://mp.weixin.qq.com/s?__biz=MzA5Mjg1NzUxNg==&mid=206658125&idx=1&sn=e2138d5d920efd1cdc00b4c27374c103#rd"><img src="themes/kezhong/images/downs-app.gif"></a></div>
                </div>
<?php } ?>
            </div>
                        			<!--保存到本地vcf<div class="save-card" id="vcard"><a target="_blank" href="http://v.qy.cn/m.php/nocheck/vcard?a=401017" ><img src="themes/kezhong/images/save-img.png"></a></div>-->
                    </div>
    </div>
...
<script src="themes/kezhong/js/jquery-1.8.3.min.js"></script>
<script>
    ...
    function show_down(t){
        if(t == 1){
            var text = "想和他一样拥有永不过期的电子名片吗？马上联系微营商务吧！";
        }else if( t == 2){
            var text = "希望轻松获得免费的个性化企业手机网站？联系微营商务就可以了！";
        }else if( t == 3){
            var text = "希望加他为好友，和他随时互动？那就和他一起用微营商务电子名片吧！";
        }
        $('#float-bg').show();
        $('.text').text(text);
        $('.pup-foot-box').show();
...
var dataForWeixin = {
    ...
    title: "",
    desc: "<?php echo $rs['realname'],$rs['weixin_desc'] ?>",
    weibodesc: "",
