...
.head{ background:url(/themes/15/images/m/head-bg.png) repeat-x; height:88px; position:relative}

	.head .logo{ margin-top:25px; margin-left:20px;}
	.head .search-bg{ background:url(/themes/15/images/m/search-img.png) no-repeat; width:367px; height:62px; margin-top:12px; margin-left:20px;}
	.head .search-bg .input-search{ height:58px; line-height:normal; width:285px; color:#7FB4DF; margin-top:2px; margin-left:50px; font-size:28px;  border:none; background:url(/themes/15/images/m/input-bg.png) repeat-x; padding-left:5px;}
...
.foot-nav{ position:fixed; bottom:0;}
	...
	.foot-nav .foot-list1 li{ float:left; background:url(/themes/15/images/m/card/foot-libg.png) repeat-y right; width:128px; text-align:center; color:#fff;text-shadow: 1px 1px 0 #454545; position:relative}
	...
	.foot-nav .foot-list3 li.t2{ width:256px;}
        ...
        .main-card38{background:#F5F1CC url(/themes/15/images/m/card/v_bg30.jpg) no-repeat; height:100%; color:#D24903 }
.main-card38 .top-qyname{  font-size:38px; padding:30px 0px 50px 65px;}
.main-card38 .card-box{padding-bottom: 60px; padding-left:65px;  line-height:42px;  font-size:40px; line-height:1.1em }
.main-card38 .card-box .name{ margin-top:15px;}
.main-card38 .card-box .name span{ font-size:24px; margin-left:10px; color:#333 }
.main-card38 .card-box .card-bg img{ border:3px solid #fff;border-radius: 5px;}
.main-card38 .card-box .position{  font-size:28px; color:#7E8D19}
.main-card38 .card-box .text-info span{ font-size:24px; color:#454545}
.main-card38 .enter-info{  font-size:28px; padding-left:65px; line-height:2.2em }
.main-card38 .enter-info img{ vertical-align:-12px; margin-right:5px;}
...
<div class="pup-box" id="pup-box">
    ...
    <a href="http://v.qy.cn/d.php?from=404619" rel="nofollow" onclick="$('#float-bg').hide();$('#pup-box').hide()"><input type="image" src="/themes/15/images/m/downs1.png"></a>　<input type="image" src="/themes/15/images/m/esc.png" id="esc_btn" onclick="$('#float-bg').hide();$('#pup-box').hide()">
</div>
<div style="background-image:url(/themes/15/images/m/card/webcard-bg.jpg); background-position: center 0;background-repeat: no-repeat;background-attachment: fixed; height:100%; background-size: cover;-webkit-background-size: cover;-o-background-size: cover;">
    <div class="main" style="height:100%;">

        <div class="content">
                        <div class="main-card38 touch">
    ...
    <div class="card-box">
        <div class="card-bg">
            ...
            <div class="name"><?php echo $rs['realname'] ?><span><?php echo $rs['job'] ?></span></div>
             <div class="position">手机：<a href="tel:<?php echo str_replace('-','',$rs['tel']) ?>"><?php echo $rs['tel'] ?></a></div>        </div>
    </div>
    <div class="enter-info">
        <p>
            <img src="/themes/15/images/m/card/card-ioc1.png" align="absmiddle"><a href="tel:<?php echo str_replace('-','',$rs['phone']) ?>"><?php echo $rs['phone'] ?></a><br>              <img src="/themes/15/images/m/card/card-ioc2.png" align="absmiddle">0769-22452700<br>             <img src="/themes/15/images/m/card/card-ioc3.png" align="absmiddle"><?php echo $rs['mail'] ?><br>            <img src="/themes/15/images/m/card/card-ioc4.png" align="absmiddle">www.ka.com<br>            <img src="/themes/15/images/m/card/card-ioc5.png" align="absmiddle"><?php echo $rs['address'] ?><br>            <div class="fx-box" style="padding-bottom: 100px;"></div>
    </div>
</div>                                    <div class="foot-nav" style="display: none;">
                <!--<div class="lx-box">
                    <div class="tit">请选择联系方式</div>
                    <ul class="cls">
                                                <li onclick="location.href='mailto:2496267464@qq.com'"><a href="#"><img src="/themes/15/images/m/card/lx_pic3.png"></a><a href="#">邮件</a></li>
                        <li onclick="window.open('http://www.kz.com')"><a href="#"><img src="/themes/15/images/m/card/lx_pic5.png"></a><a href="#">网站</a></li>
                        <li onclick="$('#float-bg').show();$('.big-code').show();shownav()"><a href="#"><img src="/themes/15/images/m/card/lx_pic6.png"></a><a href="#">二维码</a></li>
                    </ul>
                                        <div class="downs-app"><a target="_blank" href="http://v.qy.cn/d.php?from=404619" ><input type="image" src="/themes/15/images/m/card/downs-app.png"></a></div>
                                    </div>-->
    ...
    <div class="pup-foot-box">
        ...
        <p class="mt40"><input id="downbtn" type="image" src="/themes/15/images/m/card/downs-cc.png">　<input id="clear" type="image" src="/themes/15/images/m/card/esc.png" ></p>
    </div>
</div>
<script src="/themes/15/js/jquery-1.8.3.min.js"></script>
<script>
