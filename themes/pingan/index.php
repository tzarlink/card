<?php
	...
	$sql2 = "select c.username as admin_username , u.*,c.*,u.username from `card_company` c left join `card_user` u on c.id=u.pid where u.username='$_GET[u]'";
...
.main-card12 .enter-info .name{ background:#FF4604; padding:15px 20px; font-size:36px; color:#fff; margin-bottom:20px; width:560px;}
...
<div class="content">
    <div class="main-card12 touch">
		...
		<div class="enter-info">
			...
			<p>
				<img src="themes/pingan/images/tel.png" style="position:absolute;margin-top:1pt"><span style="margin-left:30pt"><a href="tel:<?php echo $rs['tel'] ?>"><?php echo $rs['tel'] ?></a></span>
				<br><br>
				<img src="themes/pingan/images/phone.png" style="position:absolute;margin-top:1pt"><span style="margin-left:30pt"><a href="tel:<?php echo $rs['phone'] ?>"><?php echo $rs['phone']; ?> </a></span>
				<br><br>
				<img src="themes/pingan/images/qq.png" style="position:absolute;margin-top:1pt"><span style="margin-left:30pt"><a href="javascript:void(0)"><?php echo $rs['qq'] ?></a></span><br><br>
				<img src="themes/pingan/images/mail.png" style="position:absolute;margin-top:2pt"><span style="margin-left:30pt"><a href="mail:<?php echo $rs['mail'] ?>"><?php echo $rs['mail'] ?></a></span><br><br>
				<img src="themes/pingan/images/address.png" style="position:absolute;margin-top:1pt"><span style="margin-left:30pt"><a href="javascript:void(0)"><?php echo $rs['address'] ?></a></span><br><br/>
				<!--<img src="themes/pingan/images/400.png" style="position:absolute;margin-top:1pt"><span style="margin-left:30pt"><a href="tel:4008981160">全国服务热线：400-898-1160 </a></span>-->
				<br><br>	
			</p>
			    ...
			    <!--<div class="lx-box">
                    <div class="tit">官方公众号</div>
						...
						<img src="themes/kezhong/images/qr.png" style="float:left"> 
								...
								微营商务成立于2012年12月26，是国内首批微信第三方应用专业开发商，是国内基于微信行业应用解决方案的专业提供商，
								专注于微信技术开发和微信营销。我们拥有自己的技术团队，具备自主开发计算机软件的能力和技术。
								能够为各行业提供专业的技术解决方案、推广方案。
								所开发出的软件功能强大、稳定、美 观易用。我们以科学的项目管理方法，严格高效的工作流程及研发方案，保证软件质量和扩充性。
								</p>
						</p>
						...
						<div style="clear:both"></div>
						  ...
						  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;服务传承文明</a>             
				<div class="downs-app"><a href="http://mp.weixin.qq.com/s?__biz=MzA5MDYyMDkxMQ==&mid=200777960&idx=1&sn=338a156ed291d7993ffb4990f6f608e4#rd"><img src="themes/kezhong/images/downs-app.gif"></a></div>
                </div>
                    ...
                    <img src="themes/pingan/images/footer_bg.jpg" />
    </div>
...
<script src="themes/pingan/js/jquery-1.8.3.min.js"></script>
<script>
