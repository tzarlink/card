...
.head{ background:url(/themes/1/images/m/head-bg.png) repeat-x; height:88px; position:relative}

	.head .logo{ margin-top:25px; margin-left:20px;}
	.head .search-bg{ background:url(/themes/1/images/m/search-img.png) no-repeat; width:367px; height:62px; margin-top:12px; margin-left:20px;}
	.head .search-bg .input-search{ height:58px; line-height:normal; width:285px; color:#7FB4DF; margin-top:2px; margin-left:50px; font-size:28px;  border:none; background:url(/themes/1/images/m/input-bg.png) repeat-x; padding-left:5px;}
...
.foot-nav{ position:fixed; bottom:0;}
	...
	.foot-nav .foot-list1 li{ float:left; background:url(/themes/1/images/m/card/foot-libg.png) repeat-y right; width:128px; text-align:center; color:#fff;text-shadow: 1px 1px 0 #454545; position:relative}
	...
	.foot-nav .foot-list3 li.t2{ width:256px;}
        ...
        .main-card53{background:#000E1D url(/themes/1/images/m/card/v_bg45.jpg) no-repeat; height:100%;color:#fff}
.main-card53 .top-qyname{ font-size:36px; padding:50px 0 0 60px; }
.main-card53 .card-box{font-size:45px; }
.main-card53 .card-box .card-bg{ padding:40px 40px 80px 60px}
.main-card53 .card-box .text-info{ margin-left:15px; float:left; line-height:1.3em;}
.main-card53 .card-box .text-info span{ font-size:24px; margin-left:10px;}
.main-card53 .card-box .card-bg img{ border:3px solid #fff;border-radius: 5px;}
.main-card53 .enter-info{ font-size:24px; padding-left:60px; line-height:1.8em;}
.main-card53 .enter-info .name{ font-size:34px; margin:20px 0;}
...
<div class="pup-box" id="pup-box">
    ...
    <a href="http://v.qy.cn/d.php?from=404619" rel="nofollow" onclick="$('#float-bg').hide();$('#pup-box').hide()"><input type="image" src="/themes/1/images/m/downs1.png"></a>　<input type="image" src="/themes/1/images/m/esc.png" id="esc_btn" onclick="$('#float-bg').hide();$('#pup-box').hide()">
</div>
<div style="background-image:url(/themes/1/images/m/card/webcard-bg.jpg); background-position: center 0;background-repeat: no-repeat;background-attachment: fixed; height:100%; background-size: cover;-webkit-background-size: cover;-o-background-size: cover;">
    <div class="main" style="height:100%;">

        <div class="content">
                        <div class="main-card53 touch">
    ...
    <div class="card-box">
        <div class="card-bg cls">
            ...
            <div class="text-info">
                <div class="name"><?php echo $rs['realname'] ?><span><?php echo $rs['job'] ?></span>
                    <p  style="font-size:26px;">手机：<a href="tel:<?php echo str_replace('-','',$rs['tel']) ?>"><?php echo $rs['tel'] ?></a></p>                    </div>
            </div>
        </div>
    </div>
    <div class="enter-info">
        ...
        <div class="fx-box" style="padding-bottom: 100px;"></div>
                ...
                <!--<div class="lx-box">
                    ...
                    <ul class="cls">
                      <li onclick="location.href='mailto:2496267464@qq.com'"><a href="#"><img src="/themes/1/images/m/card/lx_pic3.png"></a><a href="#">邮件</a></li>
                      <li onclick="window.open('http://www.kz.com')"><a href="#"><img src="/themes/1/images/m/card/lx_pic5.png"></a><a href="#">网站</a></li>
                      <li onclick="$('#float-bg').show();$('.big-code').show();shownav()"><a href="#"><img src="/themes/1/images/m/card/lx_pic6.png"></a><a href="#">二维码</a></li>
                    </ul>
                    <div class="downs-app"><a target="_blank" href="http://v.qy.cn/d.php?from=404619" ><input type="image" src="/themes/1/images/m/card/downs-app.png"></a></div>
                                    </div>-->
    ...
    <div class="pup-foot-box">
        ...
        <p class="mt40"><input id="downbtn" type="image" src="/themes/1/images/m/card/downs-cc.png">　<input id="clear" type="image" src="/themes/1/images/m/card/esc.png" ></p>
    </div>
</div>
<script src="/themes/1/js/jquery-1.8.3.min.js"></script>
<script>
