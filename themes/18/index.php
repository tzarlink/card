...
.head{ background:url(/themes/18/images/m/head-bg.png) repeat-x; height:88px; position:relative}

	.head .logo{ margin-top:25px; margin-left:20px;}
	.head .search-bg{ background:url(/themes/18/images/m/search-img.png) no-repeat; width:367px; height:62px; margin-top:12px; margin-left:20px;}
	.head .search-bg .input-search{ height:58px; line-height:normal; width:285px; color:#7FB4DF; margin-top:2px; margin-left:50px; font-size:28px;  border:none; background:url(/themes/18/images/m/input-bg.png) repeat-x; padding-left:5px;}
...
.foot-nav{ position:fixed; bottom:0;}
	...
	.foot-nav .foot-list1 li{ float:left; background:url(/themes/18/images/m/card/foot-libg.png) repeat-y right; width:128px; text-align:center; color:#fff;text-shadow: 1px 1px 0 #454545; position:relative}
	...
	.foot-nav .foot-list3 li.t2{ width:256px;}
        ...
        .main-card28{background:#040209 url(/themes/18/images/m/card/v_bg20.jpg) no-repeat; height:100%; }
.main-card28 .top-qyname{ color:#FFFDFF; font-size:38px; padding:30px 65px;}
.main-card28 .card-box{ line-height:42px; color:#fff; font-size:40px; }
.main-card28 .card-box .card-bg{ background:url(/themes/18/images/m/card/bg3.png) no-repeat; padding:40px 60px; position:fixed; bottom:100px; width:520px;}
.main-card28 .card-box .card-bg img{ border:3px solid #fff;border-radius: 5px;}
.main-card28 .card-box .text-info{ margin-left:15px; float:left; line-height:1.4em}
.main-card28 .card-bg span{ font-size:24px;}
.main-card28 .enter-info{ font-size:24px; padding-left:65px;  color:#fff; line-height:1.6em}
...
<div class="pup-box" id="pup-box">
    ...
    <a href="http://v.qy.cn/d.php?from=404619" rel="nofollow" onclick="$('#float-bg').hide();$('#pup-box').hide()"><input type="image" src="/themes/18/images/m/downs1.png"></a>　<input type="image" src="/themes/18/images/m/esc.png" id="esc_btn" onclick="$('#float-bg').hide();$('#pup-box').hide()">
</div>
<div style="background-image:url(/themes/18/images/m/card/webcard-bg.jpg); background-position: center 0;background-repeat: no-repeat;background-attachment: fixed; height:100%; background-size: cover;-webkit-background-size: cover;-o-background-size: cover;">
    <div class="main" style="height:100%;">

        <div class="content">
                        
<div class="main-card28 touch">
    ...
    <div class="enter-info">
        ...
        <div class="fx-box" style="padding-bottom: 100px;"></div>
               ...
               <!-- <div class="lx-box">
                    ...
                    <ul class="cls">
                                                <li onclick="location.href='mailto:2496267464@qq.com'"><a href="#"><img src="/themes/18/images/m/card/lx_pic3.png"></a><a href="#">邮件</a></li>
                        <li onclick="window.open('http://www.kz.com')"><a href="#"><img src="/themes/18/images/m/card/lx_pic5.png"></a><a href="#">网站</a></li>
                        <li onclick="$('#float-bg').show();$('.big-code').show();shownav()"><a href="#"><img src="/themes/18/images/m/card/lx_pic6.png"></a><a href="#">二维码</a></li>
                    </ul>
                                        <div class="downs-app"><a target="_blank" href="http://v.qy.cn/d.php?from=404619" ><input type="image" src="/themes/18/images/m/card/downs-app.png"></a></div>
                                    </div>-->
    ...
    <div class="pup-foot-box">
        ...
        <p class="mt40"><input id="downbtn" type="image" src="/themes/18/images/m/card/downs-cc.png">　<input id="clear" type="image" src="/themes/18/images/m/card/esc.png" ></p>
    </div>
</div>
<script src="/themes/18/js/jquery-1.8.3.min.js"></script>
<script>
